...
Object.entries(measurements).forEach(([endpoint, data]) => {
  if (data.length < 5) return; // Skip endpoints with < 5 measurements
  ...
  console.log(
    ...
    `${p50.toFixed(2).padStart(7)}ms | ${p95.toFixed(2).padStart(7)}ms | ` +
    `${p99.toFixed(2).padStart(7)}ms | ${avg.toFixed(2).padStart(7)}ms | ` +
